...
export class DataBaseInit1750550653251 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "company" ADD CONSTRAINT "FK_3eb2fdec484e573c795ea379403" FOREIGN KEY ("tenantId") REFERENCES "tenant"("id") ON DELETE CASCADE ON UPDATE NO ACTION`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "auction" ADD CONSTRAINT "FK_13c49647f9db0763901fd6e6a26" FOREIGN KEY ("tenantId") REFERENCES "tenant"("id") ON DELETE CASCADE ON UPDATE NO ACTION`
    );
    await queryRunner.query(
      `ALTER TABLE "item" ADD CONSTRAINT "FK_3d03c38cd1823642616862541c3" FOREIGN KEY ("tenantId") REFERENCES "tenant"("id") ON DELETE CASCADE ON UPDATE NO ACTION`
    );
    await queryRunner.query(
      `ALTER TABLE "auction_item" ADD CONSTRAINT "FK_31586b8ed365c1ec70acf1a9c1d" FOREIGN KEY ("tenantId") REFERENCES "tenant"("id") ON DELETE CASCADE ON UPDATE NO ACTION`
    );
    await queryRunner.query(
      `ALTER TABLE "auction_item" ADD CONSTRAINT "FK_545f1923d0aedebab513794cc13" FOREIGN KEY ("auctionId") REFERENCES "auction"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
      `ALTER TABLE "auction_item" ADD CONSTRAINT "FK_5be0457a800822a8e61d0afc1c8" FOREIGN KEY ("itemId") REFERENCES "item"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
      `ALTER TABLE "bid" ADD CONSTRAINT "FK_9d85ebb24e69d6dd3a9df897f2d" FOREIGN KEY ("tenantId") REFERENCES "tenant"("id") ON DELETE CASCADE ON UPDATE NO ACTION`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "bid" ADD CONSTRAINT "FK_733b44330c630550e6b88e845cd" FOREIGN KEY ("auctionItemId") REFERENCES "auction_item"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
      `ALTER TABLE "observation" ADD CONSTRAINT "FK_ab066b1acc3f115147b074943c0" FOREIGN KEY ("tenantId") REFERENCES "tenant"("id") ON DELETE CASCADE ON UPDATE NO ACTION`
    );
    await queryRunner.query(
      `ALTER TABLE "audit_log" ADD CONSTRAINT "FK_4167b21288ab6e16239cb1d5016" FOREIGN KEY ("tenantId") REFERENCES "tenant"("id") ON DELETE CASCADE ON UPDATE NO ACTION`
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "audit_log" DROP CONSTRAINT "FK_4167b21288ab6e16239cb1d5016"`
    );
    await queryRunner.query(
      `ALTER TABLE "observation" DROP CONSTRAINT "FK_ab066b1acc3f115147b074943c0"`
    );
    await queryRunner.query(
      `ALTER TABLE "bid" DROP CONSTRAINT "FK_733b44330c630550e6b88e845cd"`
    );
    await queryRunner.query(
      `ALTER TABLE "bid" DROP CONSTRAINT "FK_b0f254bd6d29d3da2b6a8af262b"`
    );
    await queryRunner.query(
      `ALTER TABLE "bid" DROP CONSTRAINT "FK_9d85ebb24e69d6dd3a9df897f2d"`
    );
    await queryRunner.query(
      `ALTER TABLE "auction_item" DROP CONSTRAINT "FK_5be0457a800822a8e61d0afc1c8"`
    );
    await queryRunner.query(
      `ALTER TABLE "auction_item" DROP CONSTRAINT "FK_545f1923d0aedebab513794cc13"`
    );
    await queryRunner.query(
      `ALTER TABLE "auction_item" DROP CONSTRAINT "FK_31586b8ed365c1ec70acf1a9c1d"`
    );
    await queryRunner.query(
      `ALTER TABLE "item" DROP CONSTRAINT "FK_3d03c38cd1823642616862541c3"`
    );
    await queryRunner.query(
      `ALTER TABLE "auction" DROP CONSTRAINT "FK_13c49647f9db0763901fd6e6a26"`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "company" DROP CONSTRAINT "FK_3eb2fdec484e573c795ea379403"`
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_23cb9d3ddce75a59880bcfa94d"`
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_435c1638210114b27fd375d37e"`
    );
    await queryRunner.query(`DROP TABLE "user"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_106fcf465bed04b3aaec8fb279"`
    );
